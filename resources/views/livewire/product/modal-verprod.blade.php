                                ...
                                <div class="md:flex md:items-center">
                                    ...
                                    <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                                        ...
                                        <div class="flex items-center mt-6">
                                            <button class="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500" wire:click="orderNow({{$productemp->id}})">Order Now</button>
